...
{
    GemListener* gemListener = [[GemListener alloc] initWithGem:gem onErrorCallback:onError stateChangedCallback:onStateChanged onCombinedDataCallback:onCombinedData onTapDataCallback:onTapData];
...
char* getGemAddress(Gem* gem)
{
    ...
    unsigned long size = strlen(utf8String) + 1;
